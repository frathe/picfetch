...
- [ ] Opening the tab inspects only. Inspection and increases that need no eviction neither delete records nor retire producers. Report applied limit and measured remaining usage without treating the general limit as a combined-cache or process-memory cap. ([V11](../ticket-execution.md#v11))
