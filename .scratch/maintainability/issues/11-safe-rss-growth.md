...
- [x] Add the specified deterministic TestRSSGrowth covering increasing, equal and decreasing uint64 samples.
- [x] The arithmetic regression runs without enabling the long RSS experiment.
- [x] Retain heicleak build selection, PICFETCH_HEIC_LEAK_TEST opt-in and the existing HEIC mitigation.
