...
- Similarity Explorer on Intel and Apple Silicon Macs, x64/ARM64 Linux with
  ...
  enforce network isolation. The privacy policy explains the platform differences.
