...
| `jpegmemory.go` | Header-only admission for the metadata-removal working-memory budget: encoded copies, padded component planes, progressive coefficients, orientation and output validation. |
