...
| `build.go` | `buildViewer` composes widgets and `registerFeatures` modules. Overlay tail: copy selection, grid, comparison (including its pointer shield), delete confirm, export prompt, toast. |
